...
class VerifyChannelCommand extends Command {
  constructor (client) {
    super(client, {
      ...
      aliases: ['trojanverifychannel', 'verificationchannel'],
  ...
  async fn (msg, args) {
    ...
    if (channel) {
      ...
      msg.reply(`Set verify channel to ${channel}. Non-verification messages in this channel will be deleted if Trojan can manage messages.`)
    } else {
