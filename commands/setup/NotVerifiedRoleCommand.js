...
class NotVerifiedRoleCommand extends Command {
  constructor (client) {
    super(client, {
      ...
      aliases: ['trojanverifiedremovedrole', 'verifiedremovedrole', 'trojannotverifiedrole', 'notverifiedrole'],
  ...
  async fn (msg, args) {
    ...
    if (role) {
      ...
      if (this.me.roles.highest.comparePositionTo(role) < 0) return msg.reply('You have attempted to bind a role above the Trojan role, please move `Trojan` up in your role list and try again.')
