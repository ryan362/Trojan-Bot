...
class CreateVerifyChannelCommand extends Command {
  constructor (client) {
    super(client, {
      ...
      aliases: ['verifycreateverifychannel', 'createverify', 'createverificationchannel', 'createverification', 'createverifychannels'],
  ...
  async fn (msg) {
    try {
      ...
      msg.reply(':no_entry_sign: Trojan does not have permission to create channels in this server.')
    }
  }
}