...
class CreateGroupRanksCommand extends Command {
  constructor (client) {
    super(client, {
      ...
      aliases: ['trojancreategroupranks'],
  ...
  async fn (msg, args) {
    if (!msg.guild.me.hasPermission('MANAGE_ROLES')) {
      return msg.reply("Trojan needs the 'Manage Roles' permission in order to do this.")
    }
    ...
    try {
      ...
      msg.reply(':no_entry_sign: Something went wrong. Maybe the group doesn\'t exist, or maybe Trojan doesn\'t have permission to create roles in this server.')
    }
  }
}