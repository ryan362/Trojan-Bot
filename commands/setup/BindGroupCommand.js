...
class BindGroupCommand extends Command {
  ...
  async fn (msg, args) {
    ...
    if (this.me.roles.highest.comparePositionTo(args.role) < 0) return msg.reply('You have attempted to bind a role above the Trojan role, please move `Trojan` up in your role list and try again.')
